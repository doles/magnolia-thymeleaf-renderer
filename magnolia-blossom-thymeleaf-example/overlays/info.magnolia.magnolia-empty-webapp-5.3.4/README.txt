...
This package contains:
   ...
   Magnolia Core 5.3.4
   Magnolia Internationalization Framework 5.3.4
   Magnolia JAAS 5.3.4
   Magnolia Imaging Module 3.1.2
   Magnolia Legacy UI 5.2.3
   Magnolia Rendering 5.3.4
   Magnolia Templating 5.3.4
   Magnolia Templating for JSP 5.3.4
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.3.4.html
